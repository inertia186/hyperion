...
(function (TagTransformingSanitizer) {
    ...
    (function (Options) {
        function validate(o) {
            ow_1.default(o.iframeWidth, "TagTransformingSanitizer.Options.iframeWidth", ow_1.default.number.integer.positive);
            ow_1.default(o.iframeHeight, "TagTransformingSanitizer.Options.iframeHeight", ow_1.default.number.integer.positive);
            ow_1.default(o.addNofollowToLinks, "TagTransformingSanitizer.Options.addNofollowToLinks", ow_1.default.boolean);
            ow_1.default(o.noImage, "TagTransformingSanitizer.Options.noImage", ow_1.default.boolean);
